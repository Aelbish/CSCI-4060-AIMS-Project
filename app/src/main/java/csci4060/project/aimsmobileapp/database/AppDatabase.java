...
@Database(entities = {Driver.class, Trip.class, Load.class, Customer.class, Vendor.class,  Delivery.class, DeliveredProduct.class, SiteInput.class, SourceInput.class}, version = 10)
    ...
    public static AppDatabase getDatabase(final Context context) {
        if(INSTANCE == null) {
            synchronized (AppDatabase.class) {
                if(INSTANCE == null) {  //The line below is the actual building of the database                                 //After version increment, it will completely destroy the database and rebuild it
