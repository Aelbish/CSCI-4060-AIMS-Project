...
import csci4060.project.aimsmobileapp.adapter.TripListAdapterWithoutDeliveries;
...
public class TripsFragmentWithoutDeliveries extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_trips_without_deliveries, container, false);

//        Referencing the recycler view UI and setting the layout manager as linear layout
        TripListRecyclerView = view.findViewById(R.id.display_trips_list_recycler_view_without_deliveries);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (tripInfoModelList.size() > 0) {
                                ...
                                TripListRecyclerView.setAdapter(new TripListAdapterWithoutDeliveries(tripInfoModelList, getContext()));
                            } else {
