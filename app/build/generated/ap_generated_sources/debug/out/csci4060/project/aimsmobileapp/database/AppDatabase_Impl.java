...
import csci4060.project.aimsmobileapp.database.dao.SiteInputDao;
import csci4060.project.aimsmobileapp.database.dao.SiteInputDao_Impl;
import csci4060.project.aimsmobileapp.database.dao.SourceInputDao;
import csci4060.project.aimsmobileapp.database.dao.SourceInputDao_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  private volatile SiteInputDao _siteInputDao;

  private volatile SourceInputDao _sourceInputDao;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(10) {
      ...
      public void dropAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("DROP TABLE IF EXISTS `SiteInput`");
        _db.execSQL("DROP TABLE IF EXISTS `SourceInput`");
        if (mCallbacks != null) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        final TableInfo _infoSiteInput = new TableInfo("SiteInput", _columnsSiteInput, _foreignKeysSiteInput, _indicesSiteInput);
        final TableInfo _existingSiteInput = TableInfo.read(_db, "SiteInput");
        if (! _infoSiteInput.equals(_existingSiteInput)) {
          return new RoomOpenHelper.ValidationResult(false, "SiteInput(csci4060.project.aimsmobileapp.database.entity.SiteInput).\n"
                  + " Expected:\n" + _infoSiteInput + "\n"
                  + " Found:\n" + _existingSiteInput);
        }
        final HashMap<String, TableInfo.Column> _columnsSourceInput = new HashMap<String, TableInfo.Column>(15);
        ...
        _columnsSourceInput.put("end_meter_reading", new TableInfo.Column("end_meter_reading", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSourceInput.put("pickup_gross_quantity", new TableInfo.Column("pickup_gross_quantity", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSourceInput.put("pickup_net_quantity", new TableInfo.Column("pickup_net_quantity", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSourceInput.put("bol_number", new TableInfo.Column("bol_number", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsSourceInput.put("pickup_ratio", new TableInfo.Column("pickup_ratio", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysSourceInput = new HashSet<TableInfo.ForeignKey>(0);
        final HashSet<TableInfo.Index> _indicesSourceInput = new HashSet<TableInfo.Index>(0);
        final TableInfo _infoSourceInput = new TableInfo("SourceInput", _columnsSourceInput, _foreignKeysSourceInput, _indicesSourceInput);
        final TableInfo _existingSourceInput = TableInfo.read(_db, "SourceInput");
        if (! _infoSourceInput.equals(_existingSourceInput)) {
          return new RoomOpenHelper.ValidationResult(false, "SourceInput(csci4060.project.aimsmobileapp.database.entity.SourceInput).\n"
                  + " Expected:\n" + _infoSourceInput + "\n"
                  + " Found:\n" + _existingSourceInput);
        }
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "Driver","Trip","Load","Customer","Vendor","Delivery","DeliveredProduct","SiteInput","SourceInput");
  }
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `SiteInput`");
      _db.execSQL("DELETE FROM `SourceInput`");
  ...
  @Override
  public SiteInputDao siteInputDao() {
    if (_siteInputDao != null) {
      return _siteInputDao;
    } else {
      synchronized(this) {
        if(_siteInputDao == null) {
          _siteInputDao = new SiteInputDao_Impl(this);
        }
        return _siteInputDao;
      }
    }
  ...
  @Override
  public SourceInputDao sourceInputDao() {
    if (_sourceInputDao != null) {
      return _sourceInputDao;
    } else {
      synchronized(this) {
        if(_sourceInputDao == null) {
          _sourceInputDao = new SourceInputDao_Impl(this);
        }
        return _sourceInputDao;
      }
    }
