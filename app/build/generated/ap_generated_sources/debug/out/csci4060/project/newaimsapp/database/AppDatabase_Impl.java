...
import csci4060.project.newaimsapp.database.dao.CustomerDao;
import csci4060.project.newaimsapp.database.dao.CustomerDao_Impl;
import csci4060.project.newaimsapp.database.dao.DeliveryDao;
import csci4060.project.newaimsapp.database.dao.DeliveryDao_Impl;
import csci4060.project.newaimsapp.database.dao.DriverDao;
import csci4060.project.newaimsapp.database.dao.DriverDao_Impl;
import csci4060.project.newaimsapp.database.dao.LoadDao;
import csci4060.project.newaimsapp.database.dao.LoadDao_Impl;
import csci4060.project.newaimsapp.database.dao.TripDao;
import csci4060.project.newaimsapp.database.dao.TripDao_Impl;
import csci4060.project.newaimsapp.database.dao.VendorDao;
import csci4060.project.newaimsapp.database.dao.VendorDao_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(8) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e1d7f83e1b705a2b9c2fab1843500362')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoDriver.equals(_existingDriver)) {
          return new RoomOpenHelper.ValidationResult(false, "Driver(csci4060.project.newaimsapp.database.entity.Driver).\n"
                  + " Expected:\n" + _infoDriver + "\n"
                  + " Found:\n" + _existingDriver);
        }
        ...
        if (! _infoTrip.equals(_existingTrip)) {
          return new RoomOpenHelper.ValidationResult(false, "Trip(csci4060.project.newaimsapp.database.entity.Trip).\n"
                  + " Expected:\n" + _infoTrip + "\n"
                  + " Found:\n" + _existingTrip);
        }
        ...
        if (! _infoLoad.equals(_existingLoad)) {
          return new RoomOpenHelper.ValidationResult(false, "Load(csci4060.project.newaimsapp.database.entity.Load).\n"
                  + " Expected:\n" + _infoLoad + "\n"
                  + " Found:\n" + _existingLoad);
        }
        ...
        if (! _infoCustomer.equals(_existingCustomer)) {
          return new RoomOpenHelper.ValidationResult(false, "Customer(csci4060.project.newaimsapp.database.entity.Customer).\n"
                  + " Expected:\n" + _infoCustomer + "\n"
                  + " Found:\n" + _existingCustomer);
        }
        ...
        if (! _infoVendor.equals(_existingVendor)) {
          return new RoomOpenHelper.ValidationResult(false, "Vendor(csci4060.project.newaimsapp.database.entity.Vendor).\n"
                  + " Expected:\n" + _infoVendor + "\n"
                  + " Found:\n" + _existingVendor);
        }
        ...
        if (! _infoDelivery.equals(_existingDelivery)) {
          return new RoomOpenHelper.ValidationResult(false, "Delivery(csci4060.project.newaimsapp.database.entity.Delivery).\n"
                  + " Expected:\n" + _infoDelivery + "\n"
                  + " Found:\n" + _existingDelivery);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "e1d7f83e1b705a2b9c2fab1843500362", "9c952fecd4e765511d260af52bd41465");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "Driver","Trip","Load","Customer","Vendor","Delivery");
  }
